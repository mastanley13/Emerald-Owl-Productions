          ...
          <div className={`text-center md:text-left transition-all duration-1000 ease-out ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'}`}>
            ...
            */}
            ...
            <div className="mt-12 flex flex-wrap items-center justify-center md:justify-start gap-x-8 gap-y-4">
              {[ 
                { text: "2022 & 2025 NCAF&E Supporting Member of the Year", url: "#", img: "/images/award-badge-2.png" },
                { text: "2022 Best NC Downtown Event – Electric Light Fantasy", url: "#", img: "/images/award-badge-3.png" },
                { text: "Better Business Bureau A+ rating", url: "#", img: "/images/bbb-a-plus-rating.png" }
