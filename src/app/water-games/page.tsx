      ...
      <main className="pt-16">
        ...
        <section className="relative min-h-[500px] flex items-center bg-gradient-to-b from-black via-black to-sky-950 text-white">
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-b from-black/90 via-black/80 to-sky-950/80 backdrop-blur-[2px]" />
            
            {/* Decorative water elements */}
            <div className="absolute -top-24 -right-24 w-96 h-96 rounded-full bg-sky-500/10 opacity-70 animate-pulse"></div>
            ...
            <div className="absolute -bottom-32 right-32 w-80 h-80 rounded-full bg-sky-500/10 opacity-70 animate-pulse" style={{ animationDuration: '12s' }}></div>
          </div>
        ...
        <section className="bg-white py-20">
          <div className="container mx-auto px-6 text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              <span className="text-sky-600">Full Page Coming Soon</span>
            </h2>
            <p className="text-gray-700 max-w-2xl mx-auto mb-12">
              We're currently updating this page with detailed information about our Water Games experiences.
              Please check back soon or contact us directly for information about booking a Water Games event.
            </p>
            <Link 
              href="/contact-us" 
