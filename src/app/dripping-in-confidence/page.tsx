        ...
        <section className="bg-white py-20">
          <div className="container mx-auto px-6 text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              <span className="text-pink-600">Full Page Coming Soon</span>
            </h2>
            <p className="text-gray-700 max-w-2xl mx-auto mb-12">
              We're currently updating this page with detailed information about our Dripping in Confidence experiences.
              Please check back soon or contact us directly for information about booking a Dripping in Confidence event.
            </p>
            <Link 
              href="/contact-us" 
