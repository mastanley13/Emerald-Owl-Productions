      ...
      <main className="pt-16">
        ...
        <section className="relative min-h-[500px] flex items-center bg-gradient-to-b from-black via-black to-teal-950 text-white">
          <div className="absolute inset-0 overflow-hidden">
            ...
            <div className="absolute -bottom-32 right-32 w-80 h-80 rounded-full bg-teal-500/10 opacity-70 animate-pulse" style={{ animationDuration: '12s' }}></div>
          </div>
          ...
          <div className="container mx-auto px-6 z-10 relative py-16">
            <div className="max-w-4xl">
              ...
              <div className="flex flex-wrap gap-5">
                <Link 
                  href="/contact-us" 
                  className="bg-teal-600 hover:bg-teal-700 text-white font-bold py-4 px-10 rounded-full transition-all duration-300 shadow-xl hover:shadow-teal-300/60 hover:-translate-y-1 transform"
                >
                  Book Now
                </Link>
              </div>
        ...
        <section className="bg-white py-20">
          <div className="container mx-auto px-6 text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              <span className="text-teal-600">Full Page Coming Soon</span>
            </h2>
            <p className="text-gray-700 max-w-2xl mx-auto mb-12">
              We're currently updating this page with detailed information about our Sensory Friendly Experiences.
              Please check back soon or contact us directly for information about booking a Sensory Friendly event.
            </p>
            <Link 
              href="/contact-us" 
              className="bg-teal-600 hover:bg-teal-700 text-white font-bold py-3 px-8 rounded-full transition-colors inline-block"
            >
