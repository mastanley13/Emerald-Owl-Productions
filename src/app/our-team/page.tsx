...
const teamMembers = [
  ...
  },
  {
    ...
    bio: [
      'Based in the heart of North Carolina, Christina is eager to build partnerships through the Tar Heel State and beyond. As a former student of Dance Marathon, Christina understands the challenges of fundraising in schools today, and the opportunities that come with it.'
    ]
  },
  {
    name: 'SUSAN KELLUM',
