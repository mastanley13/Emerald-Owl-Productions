              ...
              <div>
                ...
                <div className="mt-10">
                  ...
                  <div className="flex space-x-4">
                    <a href="https://www.facebook.com/emeraldowlproductions/" target="_blank" rel="noopener noreferrer" className="p-2 bg-emerald-100 rounded-full text-emerald-700 hover:bg-emerald-200 transition-colors">
                    ...
                    <a href="https://www.instagram.com/emeraldowlproductions/" target="_blank" rel="noopener noreferrer" className="p-2 bg-emerald-100 rounded-full text-emerald-700 hover:bg-emerald-200 transition-colors">
                      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://www.linkedin.com/company/emerald-owl-productions-inc/" target="_blank" rel="noopener noreferrer" className="p-2 bg-emerald-100 rounded-full text-emerald-700 hover:bg-emerald-200 transition-colors">
                      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                         <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                      </svg>
                    </a>
                    <a href="https://www.youtube.com/channel/UCX5gmpLiKQgOwlcSOwZbUuQ" target="_blank" rel="noopener noreferrer" className="p-2 bg-emerald-100 rounded-full text-emerald-700 hover:bg-emerald-200 transition-colors">
                     <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
